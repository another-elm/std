...
var $author$project$OperatorExample$main = function () {
	var m = A2($author$project$OperatorExample$compositionExample, 21, 4);
	var _v0 = $author$project$OperatorExample$ident(true);
...
_Platform_export({'OperatorExample':{'init':$author$project$OperatorExample$main(
