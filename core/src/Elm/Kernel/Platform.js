...
const _Platform_browserifiedSendToApp = (runtimeId) => (message, updateMetadata) => {
  const meta = updateMetadata ? __Effect_SyncUpdate : __Effect_AsyncUpdate;
...
// "use" global variables to keep eslint happy
const _Platform_markAsyncUpdateAsUsed = __Effect2_AsyncUpdate;
const _Platform_markSyncUpdateAsUsed = __Effect2_SyncUpdate;
