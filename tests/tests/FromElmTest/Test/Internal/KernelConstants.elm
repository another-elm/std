module FromElmTest.Test.Internal.KernelConstants exposing (kernelConstants)

{-| This module FromElmTest.defines the mapping of optimized field name and enum values
